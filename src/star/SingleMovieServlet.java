...
public class SingleMovieServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        try (Connection conn = dataSource.getConnection()) {
            ...
            String query =
                    "SELECT m.id, m.title, m.year, m.director, IFNULL(r.rating, 'N/A') as rating, m.price " +
            ...
            JsonObject movieObj = jsonArray.get(0).getAsJsonObject();
            String movieId = movieObj.get("movie_id").getAsString();

            // Functions Class
            JsonObject stars = Functions.retrieveSingleMovieStars(movieId, response, out, conn);
            JsonObject genres = Functions.retrieveMovieGenres(movieId, 0, response, out, conn);
